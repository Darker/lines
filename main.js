...
function(Game, EventProxy, Controls, GameRenderer, Async, Filters, io, settings) {
      console.info("Initializing game clases.")
      ...
      console.info("Initializing game clases - DONE");
});
...
requirejs(["jquery"], function() {
  ...
  console.info("Initializing game UI.")
  /**
   * New player notifier
  **/
  ...
  console.info("Initializing game UI - DONE");
});
